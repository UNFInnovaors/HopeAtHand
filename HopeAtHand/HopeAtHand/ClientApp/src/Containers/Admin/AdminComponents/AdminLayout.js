...
import { Button, Grid, TextField, Select, MenuItem, Paper, Typography } from '@material-ui/core'
...
const AdminLayout = (props) => {
    const Facilitators = props.facilitators === null ? <Heading>No Matching Results</Heading> : 
        props.facilitators.map( (fac,index) => {
            console.log(fac)
            return <EachUser id={fac.facilitatorID} role={fac.role} name={fac.username} update={props.update}/>
        })
    ...
    <Grid container spacing={24}>
            ...
            <Grid item xs={6}><Typography align='center' variant='h3'>Manage Facilitators</Typography></Grid>
            <Grid xs={1}></Grid>
